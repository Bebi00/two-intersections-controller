...
public class InputREL extends JFrame {
	...
	public InputREL() {
		...
		final JTextPane txtE = new JTextPane();
		txtE.setText("4");
		txtE.setToolTipText("");
		...
		final JTextPane txtR = new JTextPane();
		txtR.setText("5");
		txtR.setBounds(10, 61, 285, 20);
		contentPane.add(txtR);

		final JTextPane txtL = new JTextPane();
		txtL.setToolTipText("");
		txtL.setText("6");
		txtL.setBounds(10, 123, 285, 20);
		contentPane.add(txtL);

		final JTextPane txtPlace = new JTextPane();
