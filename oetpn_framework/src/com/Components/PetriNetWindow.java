...
import com.Interfaces.PetriObject;
import com.OETPNGraphics.GraphArc;
import com.OETPNGraphics.GraphPlace;
import com.OETPNGraphics.GraphTransition;
import com.OETPNGraphics.OETPNShape;
import com.OETPNGraphics.Point;
import com.Utilities.Functions;
...
public class PetriNetWindow extends JFrame {
	...
	public PetriNetWindow(final boolean autoStart) {
		setBounds(100, 100, 805, 700);
		this.AutoStart = autoStart;
		final JPanel pnlGraphics = new JPanel();

		final JComboBox<String> cbGraphFilter = new JComboBox<String>();
		...
		final JTextPane txtMetrices = new JTextPane();
	...
	public void addString(final DefaultListModel<String> model, final JScrollPane scrollPane, final String msg, final JList<String> lstMsg) {
