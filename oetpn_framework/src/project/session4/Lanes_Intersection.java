...
public class Lanes_Intersection {
	public static void main(String[] args) {
		...
		grdT112.Activations.add(new Activation(t1, "full", TransitionOperation.SendOverNetwork, "op1"));
		grdT112.Activations.add(new Activation(t1, "P_a1", TransitionOperation.Move, "P_a1"));
...
//		t2.Delay = 3;
		...
		grdT32.Activations.add(new Activation(t3, "full", TransitionOperation.SendOverNetwork, "op2"));
		grdT32.Activations.add(new Activation(t3, "P_a2", TransitionOperation.Move, "P_a2"));
		...
		grdT52.Activations.add(new Activation(t5, "full", TransitionOperation.SendOverNetwork, "op3"));
		...
		grdT72.Activations.add(new Activation(t7, "full", TransitionOperation.SendOverNetwork, "op4"));
		grdT72.Activations.add(new Activation(t7, "P_a4", TransitionOperation.Move, "P_a4"));
		t7.GuardMappingList.add(grdT72);
		...
		Condition t_g4NCt1 = new Condition(t_g4N, "P_o4Exit", TransitionCondition.NotNull);

		GuardMapping grdt_g4N = new GuardMapping();
		grdt_g4N.condition = t_g4NCt1;
		grdt_g4N.Activations.add(new Activation(t_g4N, "P_o4Exit", TransitionOperation.SendOverNetwork, "P_o4N"));
		t_g4N.GuardMappingList.add(grdt_g4N);
